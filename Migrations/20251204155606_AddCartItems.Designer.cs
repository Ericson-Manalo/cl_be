...
namespace cl_be.Migrations
{
    ...
    [Migration("20251204155606_AddCartItems")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("cl_be.Models.Address", b =>
                {
            ...
            modelBuilder.Entity("cl_be.Models.BuildVersion", b =>
                {
            ...
            modelBuilder.Entity("cl_be.Models.CartItem", b =>
                {
                    ...
                    b.ToTable("CartItems", "SalesLT", t =>
                        {
                            t.HasComment("Shopping cart items selected by users but not yet purchased.");
                        });
                });
            ...
            modelBuilder.Entity("cl_be.Models.CustomerAddress", b =>
                {
                    b.Property<int>("CustomerId")
                        .HasColumnType("int")
                        .HasColumnName("CustomerID")
            ...
            modelBuilder.Entity("cl_be.Models.ErrorLog", b =>
                {
            ...
            modelBuilder.Entity("cl_be.Models.ProductCategory", b =>
                {
                    b.Property<int>("ProductCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("cl_be.Models.ProductDescription", b =>
                {
            ...
            modelBuilder.Entity("cl_be.Models.ProductModel", b =>
                {
                    b.Property<int>("ProductModelId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("cl_be.Models.ProductModelProductDescription", b =>
                {
                    b.Property<int>("ProductModelId")
                        .HasColumnType("int")
                        .HasColumnName("ProductModelID")
            ...
            modelBuilder.Entity("cl_be.Models.SalesOrderDetail", b =>
                {
            ...
            modelBuilder.Entity("cl_be.Models.SalesOrderHeader", b =>
                {
                    b.Property<int>("SalesOrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("cl_be.Models.VGetAllCategory", b =>
                {
            ...
            modelBuilder.Entity("cl_be.Models.VProductAndDescription", b =>
                {
                    b.Property<string>("Culture")
                        .IsRequired()
                        .HasMaxLength(6)
            ...
            modelBuilder.Entity("cl_be.Models.VProductModelCatalogDescription", b =>
                {
            ...
            modelBuilder.Entity("cl_be.Models.CustomerAddress", b =>
                {
                    b.HasOne("cl_be.Models.Address", "Address")
            ...
            modelBuilder.Entity("cl_be.Models.Product", b =>
                {
                    b.HasOne("cl_be.Models.ProductCategory", "ProductCategory")
                        .WithMany("Products")
                        .HasForeignKey("ProductCategoryId");

                    b.HasOne("cl_be.Models.ProductModel", "ProductModel")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("cl_be.Models.ProductCategory", b =>
                {
                    b.HasOne("cl_be.Models.ProductCategory", "ParentProductCategory")
            ...
            modelBuilder.Entity("cl_be.Models.ProductModelProductDescription", b =>
                {
                    b.HasOne("cl_be.Models.ProductDescription", "ProductDescription")
            ...
            modelBuilder.Entity("cl_be.Models.SalesOrderDetail", b =>
                {
                    ...
                    b.HasOne("cl_be.Models.SalesOrderHeader", "SalesOrder")
                        .WithMany("SalesOrderDetails")
            ...
            modelBuilder.Entity("cl_be.Models.SalesOrderHeader", b =>
                {
                    b.HasOne("cl_be.Models.Address", "BillToAddress")
                    ...
                    b.HasOne("cl_be.Models.Address", "ShipToAddress")
